  ...
  return (
    <main className="min-h-screen bg-[#0b0f17] text-white antialiased">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 pt-24 pb-20 lg:px-8 lg:pt-28">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <Link href="/full" className="group inline-flex items-center rounded-2xl bg-indigo-500 px-5 py-3 text-base font-semibold text-white shadow-lg shadow-indigo-500/20 transition hover:bg-indigo-400">
                Start assessment
      ...
      {/* ARCHETYPE PREVIEW */}
      <section id="archetypes" className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          ...
          {["Sovereign","Rebel","Visionary","Guardian","Navigator","Seeker","Vessel","Partner","Diplomat","Spotlight","Architect","Provider"].map((name) => (
            <div key={name} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-4 hover:bg-white/10 transition">
              <div className="flex h-32 flex-col items-center justify-center gap-2">
                <img src={`/${name.toLowerCase()}.png`} alt={name} className="h-24 w-24 object-contain" />
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-indigo-600/20 via-violet-600/20 to-sky-500/20 p-8">
          ...
          <div className="relative">
            ...
            <div className="mt-5">
              <Link href="/full" className="inline-flex items-center rounded-2xl bg-indigo-500 px-5 py-3 text-white shadow-lg shadow-indigo-500/20 transition hover:bg-indigo-400">
                Start assessment
              </Link>
            </div>
          </div>
