      ...
      <main className="app min-h-screen bg-canvas text-ink">
        ...
        <div className="card">
          ...
          <div style={{ textAlign: "center", padding: 40 }}>
            ...
            <div className="text-lg text-ink mb-3">Generating your Operating Manual...</div>

            <div className="text-sm text-ink-muted">Analyzing your assessment results...</div>
      ...
      <main className="app min-h-screen bg-canvas text-ink">
        ...
        <div className="card">
          ...
          <div style={{ textAlign: "center", padding: 40 }}>
            ...
            <div className="text-lg text-red-600 mb-3">Error</div>
