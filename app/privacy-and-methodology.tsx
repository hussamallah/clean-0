        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6">
          {activeTab === 'privacy' && (
            <div>
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                Your privacy is critically important to us. This policy outlines how we handle your data throughout the Point Zero assessment process. Our goal is to be fully transparent while safeguarding your information.
              </p>
          ...
          {activeTab === 'methodology' && (
            <div>
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                The Point Zero assessment is built upon established principles of psychometrics and personality theory, primarily leveraging the Five-Factor Model (also known as the Big Five).
              </p>
              <ul className="list-disc list-inside mt-4 space-y-2 text-sm text-white/80">
